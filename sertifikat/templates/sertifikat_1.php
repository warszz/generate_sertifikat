<?php
// Template Seminar Certificate - Professional Modern Design
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * {
        ...
        .left-border {
            ...
            width: 20px;
            height: 100%;
            background: linear-gradient(to bottom, #1e3a8a 0%, #2563eb 50%, #1e3a8a 100%);
        }
...
<body>
    <div class="certificate">
        ...
        <div class="content">
            ...
            <div class="subtitle">PENYELESAIAN SEMINAR</div>
            ...
            <div class="certificate-text">
                ...
                dengan menunjukkan sikap profesional, antusiasme, dan dedikasi tinggi.<br>
                Peserta telah memenuhi semua persyaratan yang berlaku.
            </div>
            ...
            <div class="certificate-number">
                Nomor Sertifikat: CERT-<?= date('Ymd'); ?>-<?= str_pad(rand(1, 999), 3, '0', STR_PAD_LEFT); ?>
            </div>
        </div>
    </div>
</body>
